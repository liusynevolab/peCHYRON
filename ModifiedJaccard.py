...
dn = hierarchy.dendrogram(z, ax = axes[1], labels=jacDF.index, leaf_rotation=90)
axes[1].set_title('Jaccard Dendrogram')

z = hierarchy.linkage(prefixDF, 'average')
dn = hierarchy.dendrogram(z, ax = axes[0], labels=prefixDF.index, leaf_rotation=90)
axes[0].set_title('PTJ Dendrogram')
plt.savefig('prefix_jaccard vs jaccard dendrogram')
#plt.show()